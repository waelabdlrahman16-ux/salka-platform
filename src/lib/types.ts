export interface Restaurant {
  ...
  /** When true the customer must pick a delivery slot before ordering. A
   *  per-vendor switch, NOT a property of being a supermarket -- it used to be
   *  hardcoded as `vendor_type === 'supermarket'`, which forced slots on every
   *  market and allowed them for nobody else. Toggled from Admin. */
