...
export type AdminReportAction = 'customerDetail' | 'customers' | 'dailyReport' | 'funnel' | 'listAccounts' | 'liveDeliveries' | 'pendingRefunds' | 'pushHealth' | 'stalledOrders' | 'vendorsWithoutItems'
