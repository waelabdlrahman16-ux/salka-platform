...
const KNOWN = ["admin_only","already_confirmed","audit_mark_too_late","deposit_not_required","driver_not_found","duplicate_credit","invalid_audit_reason","invalid_credit_amount","invalid_order_id","invalid_phone","negative_total","order_cancelled","order_not_closed","order_not_found","payment_not_claimed","reason_required","reason_too_long","refund_not_pending","test_order_has_financial_or_customer_history","test_order_required"]
