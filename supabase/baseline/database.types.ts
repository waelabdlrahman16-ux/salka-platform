  ...
  private: {
    ...
    Functions: {
      ...
      admin_add_menu_category: {
        Args: { p_name: string; p_restaurant_id: number };
        Returns: number;
      };
      admin_adjust_order: {
        Args: {
      ...
      admin_archive_order: { Args: { p_order_id: number }; Returns: Json };
      admin_assign_order: {
      ...
      admin_create_addon_library_item: {
        ...
        Returns: Database["public"]["Tables"]["vendor_addon_library"]["Row"];
        SetofOptions: {
          from: "*";
      ...
      admin_delete_test_order: { Args: { p_order_id: number }; Returns: Json };
      admin_flag_driver_dispute: {
        Args: { p_complaint_id: number; p_note?: string };
        Returns: undefined;
      };
      ...
      admin_live_deliveries: { Args: never; Returns: Json };
      admin_mark_order_as_test: {
        Args: { p_order_id: number; p_reason: string };
        Returns: Json;
      };
      admin_pending_account_recoveries: { Args: never; Returns: Json };
      ...
      admin_rename_menu_category: {
        Args: { p_new: string; p_old: string; p_restaurant_id: number };
        Returns: undefined;
      };
      admin_reorder_menu_categories: {
        Args: { p_names: string[]; p_restaurant_id: number };
        Returns: undefined;
      };
      ...
      admin_set_compound_fee: {
        Args: { p_compound_id: number; p_fee: number };
        Returns: undefined;
      };
      ...
      admin_set_restaurant_service_fee: {
        Args: { p_pct: number; p_restaurant_id: number };
        Returns: undefined;
      };
      ...
      admin_set_vendor_slots: {
        Args: { p_enabled: boolean; p_restaurant_id: number };
        Returns: boolean;
      };
      ...
      admin_update_addon_library_item: {
        Args: { p_item_id: number; p_price: number };
        Returns: undefined;
      };
      ...
      apply_restaurant_service_fee: {
        Args: { p_restaurant_id: number };
        Returns: undefined;
      };
      available_orders: { Args: never; Returns: Json };
      cancel_order: {
      ...
      delivery_fee_for_restaurant: {
        Args: { p_compound_id: number; p_restaurant_id: number };
        Returns: number;
      };
      driver_accept_assignment: {
        Args: { p_assignment_id: number; p_order_id: number };
        Returns: undefined;
      };
      ...
      driver_reject_assignment: {
        Args: { p_assignment_id: number; p_reason?: string };
        Returns: undefined;
      };
      ...
      expire_custom_order_quotes: { Args: never; Returns: number };
      get_current_custom_order_quote: {
        Args: { p_order_id: number; p_order_token: string };
        Returns: Json;
      };
      issue_custom_order_quote: {
        Args: {
          p_expires_at: string;
          p_idempotency_key: string;
          p_order_id: number;
      ...
      promo_discount_for: {
        Args: {
          p_delivery_fee: number;
          p_promo: Database["public"]["Tables"]["promo_codes"]["Row"];
      ...
      reprice_order: { Args: { p_order_id: number }; Returns: undefined };
    ...
    Tables: {
      ...
      order_quotes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "order_quotes_promo_code_id_fkey";
      ...
      orders: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "orders_current_quote_id_fkey";
          ...
          {
            foreignKeyName: "orders_current_quote_matches_order_fk";
            columns: ["current_quote_id", "id"];
            isOneToOne: false;
            referencedRelation: "order_quotes";
